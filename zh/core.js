...
var cnItems = {
	...
	//教程
	"232 years have passed since you boarded the Vitha, but finally you reached your new home Promision!":
		"距您登上维塔殖民船已经过去了232年，终于您来到了新家——普罗米森！",
	...
	"In this interface, you can construct buildings to extract resources. By clicking on the desired building, you can see more details about it":
		"在这个页面下，您可以建造开采各类资源的建筑。单击建筑，您将看到关于各个建筑的详细信息",
	"On the left you can see how many resources are being produced every second.":
		"在左侧您可以看到每秒钟各项资源的生产速度",
	"Now click on the": "现在点击",
	"icon below the": "图标（位于",
	"to build 1 more": "下方）来建造另一个采矿场",
	"Perfect! You can now see on the right how iron production has doubled!":
		"干得好！您现在可以在右侧看到铁的产量已经翻倍",
	"Keep building Mining Plants, until you reach 10 of them. Should only take few seconds!":
		"继续建造直到您拥有10个采矿场，这应该不会花费太多时间",
	"Perfect! But Iron is not the only resource you will need. Let's build":
		"干得好！但是铁并不是您所需要的唯一资源，让我们建造",
	"(right below the": "（就在",
	") to extract": "的正下方）来开采",
	...
	"to convert methane into fuel. By clicking on it, you can see that it consumes 2 methane every second to produce fuel.":
		"来把甲烷转化为燃料。通过点击它，您可以看到它每秒消耗 2 甲烷来生产燃料",
	"Well done! But wait, now your production of methane is negative, because the processer needs 2 methane every second! Build another":
		"干得好！但别着急，现在您的甲烷生产速度是负数，因为生产燃料每秒要消耗 2 甲烷。请再建造一座",
	"That's good! You can now produce fuel without running out of methane. You will need fuel to power":
		"不错！现在您可以生产燃料而不必担心耗尽甲烷了，您将需要燃料来运行",
	Foundries: "铸造厂",
	...
	Alptraum: "阿尔普特劳姆",
	Engel: "恩格尔",
	"U.N.I.T Natsumiko": "U.N.I.T 夏美子",
	"U.N.I.T Harumiko": "U.N.I.T 春美子",
	"U.N.I.T Akimiko": "U.N.I.T 秋美子",
	"U.N.I.T Fuyumiko": "U.N.I.T 冬美子",
	Auxilia: "奥克西利亚",
	Augustus: "奥古斯都",
	Leonidas: "列奥尼达",
	Alexander: "亚历山大",
	...
	"Dead Soul": "死魂",
	"Halean Spear": "哈伦之矛",
	"Halean Counselor Ship": "哈伦谋士舰",
	"Juini's Daughter": "朱伊尼之女",
	"Azure Huang": "湛蓝之煌",
	"Dream of Juini": "朱伊尼之梦",
	Siren: "塞壬",
	"Servant of the Swarm": "虫群仆从",
	"Enslaved Human Ship": "被奴役的人类战舰",
	"Enslaved Quris Ship": "被奴役的古里斯战舰",
	"Enslaved Halean Ship": "被奴役的哈伦战舰",
	"Heart of the Swarm": "虫群之心",
	"Aurea Spina": "金色棘脊",
	"Auxilia Beta": "奥克西利亚·贝塔",
	"Re-engineered Servant": "改造仆从",
	Cherub: "智天使",
	Seraph: "炽天使",
	Jericho: "杰里科",
	Sodom: "索多玛",
	...
	Salantara: "萨兰塔拉",
	Bellerophon: "柏勒罗丰",
	"Wings of Pegasus": "飞马之翼",
	"Orion Cargo": "猎户座货船",
	"Orion League Delivery Vessel": "猎户座联盟运输舰",
	"Anger of Perseus": "珀尔修斯之怒",
	"Medusa Miner": "美杜莎采矿舰",
	Nux: "纳克斯",
	Max: "马克斯",
	Furiosa: "芙莉欧莎",
	...
	Maegera: "墨格拉",
	Tisiphon: "提西丰",
	"Light's Mexager": "光之信使",
	"Light's Companion": "光之伴侣",
	Vela: "维拉",
	Yola: "约拉",
	Ambjenze: "安本泽",
	Zannsarig: "赞萨里格",
	"U.N.I.T Zero": "U.N.I.T 零号",
	"U.N.I.T Reppu": "U.N.I.T 烈风",
	Glissard: "格利萨德",
	Nabonidus: "那波尼德",
	...
	"Plus Caerul": "普拉斯凯鲁",
	"Zhura Nova": "朱拉诺瓦",
	"Epsilon Rutheni": "艾普西隆·鲁西尼",
	Phorun: "佛润",
	Kitrion: "柯屯",
	Mermorra: "梅尔莫拉",
	Kandi: "坎迪",
	"Shin Sung": "新星",
	"Xora Tauri II": "佐拉·陶里II",
	Tsartasis: "察尔塔西斯",
	"New Babilo": "新巴比伦",
	"Lone Nassaus": "孤独纳索斯",
...
var cnItem = function () {
	...
	for (let i in cnItems) {
		...
		if (text == i || (text == cnItems[i] && cnItems[i] != ""))
	...
	for (let i = 0; i < cnItems._OTHER_.length; i++) {
		//已收录则直接返回；但若前/后缀有翻译，仍输出半翻译版本
		if (save_text == cnItems._OTHER_[i]) {
			return hadAffix ? text_prefix + text + text_reg_exclude_postfix + text_postfix : arguments[0];
		}
	}
    ...
    */
	...
	//返回生词字串
	// 若前/后缀已命中翻译，仍保留前后缀部分的翻译结果，避免动态拼接如
	// "[Enemy] PlayerName" 因内部词未在字典而整体丢回原文。
	if (hadAffix) {
		return text_prefix + text + text_reg_exclude_postfix + text_postfix;
	}
	return arguments[0];
